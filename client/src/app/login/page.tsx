                        ...
                        <div className="rounded-xl bg-white shadow-xl">
                            <section className="p-6 sm:p-16">
                                ...
                                <div className="mt-32 space-y-4 text-gray-600 text-center sm:-mb-8">
                                    <p className="text-xs">By proceeding, you agree to our <Link href="#" className="underline hover:text-blue-600 transition duration-300">Terms of Use</Link> and confirm you have read our <Link href="#" className="underline hover:text-blue-600 transition duration-300">Privacy and Cookie Statement</Link>.</p>
                                </div>
                            </section>
                        </div>
                    </div>
